...
bot = telebot.TeleBot('5078899670:AAHyavUmpVqnwIN3UKBfLDCqkwGPHNrlEKg')

conn = psycopg2.connect(database="rasspisanie", user="postgres", password="xinoZLa228", host="localhost", port="5432")
cursor = conn.cursor()
